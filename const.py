...
# Burgernet actions (v2) for location-based filtering
BURGERNET_ACTIONS_API = "https://www.landelijkemeldkamer.org/burgernet/burgernet-api/v2/actions"
# Burgernet image endpoint (format with action id and imageId)
BURGERNET_IMAGE_API = "https://www.landelijkemeldkamer.org/burgernet/burgernet-api/v2/actions/{id}/image/{imageId}"
...
# Config keys
CONF_BURGERNET_API_KEY = "burgernet_api_key"
