  ...
  return <div className="app">
    ...
    <section className="workspace">
      ...
      <section className={'feed glass '+(mobileList?'mobile-open':'')} aria-label="Meldingen">
        ...
        <div className="feed-footer"><i/>{isDemo?'Voorbeeldgegevens':`${Object.values(data?.sources||{}).filter(s=>s.ok).length}/3 bronnen bereikbaar`}<span>Elke {Math.round((data?.poll_seconds||180)/60*10)/10} min. bijgewerkt</span></div>
      </section>
